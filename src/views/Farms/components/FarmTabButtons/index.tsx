...
const FarmTabButtons: React.FC<Btn> = ({ stakedOnly, setStakedOnly, list, card, setList, setCard }) => {
  ...
  return (
    <Wrapper>
      ...
      <Icon>
      <ListViewIcon width="2rem" color="#e5e5e5" style={{cursor:"pointer"}} onClick={()=> {setList(true) ; setCard(false)} } />
      <CardViewIcon width="2.2rem" color="#e5e5e5" style={{marginLeft:"1rem",cursor:"pointer"}} onClick={()=>{ setCard(true);setList(false)} }/>
      </Icon>
